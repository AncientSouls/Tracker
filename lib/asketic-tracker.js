...
function mixin(superClass, trackerClass) {
    return class AsketicTracker extends superClass {
        ...
        resolveItemsTracker(flow, tracker, adapter, query) {
            return this.resolveItemsArray(flow, exports.wrapTracker(tracker, adapter, query));
        }
        resolveDefault(flow) {
...
exports.wrapTracker = (tracker, adapter, query) => __awaiter(this, void 0, void 0, function* () {
